...
setup: ; set up ports
    ...
    bcf LATC,0 ;start A at 0
    bcf LATC,1 ;start B at 0
    bsf LATC,2

mainLoop:
    ;generate square waves
    bsf ((PORTC) and 0FFh), 0, a ;1 cycle
    NOP
    NOP ;2cycles
    bcf ((PORTC) and 0FFh), 2, a
    NOP
    NOP
    bsf ((PORTC) and 0FFh), 1, a
    NOP
    NOP
    bcf ((PORTC) and 0FFh), 0, a
    NOP
    NOP
    bsf ((PORTC) and 0FFh), 2, a
    NOP
    NOP
    bcf ((PORTC) and 0FFh), 1, a
    goto mainLoop
