...
; CONFIG5
  CONFIG WDTCPS = WDTCPS_6 ; WDT Period selection bits (Divider ratio 1:2048)
...
setup: ; setup board
    ...
    BANKSEL TRISC ;
    MOVLW B'00000000' ;Set RC as input
    MOVWF TRISC ;and set others as outputs



mainLoop: ; main loop
    BSF LATC,0 ; turn on far right led
    SLEEP ; sleep 64ms
    BCF LATC,0
