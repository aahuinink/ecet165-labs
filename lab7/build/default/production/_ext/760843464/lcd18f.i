...
extern void LCDinit();
# 69 "../lab6/lcd18f.h"
extern unsigned char LCDprint(char *c);
...
extern unsigned char LCDgoto(unsigned char pos);
...
unsigned char busy(){
    ...
    LATD6 = 1; _delay((unsigned long)((1)*(64000000/4000000.0))); LATD6 = 0;
...
void LCDinstruct(unsigned char instr){
    ...
    ANSELD = 0x0; _delay((unsigned long)((1)*(64000000/4000000.0))); TRISD = 0x0; _delay((unsigned long)((1)*(64000000/4000000.0))); LATD7 = 1; _delay((unsigned long)((1)*(64000000/4000000.0)));;
    ...
    PORTD = (PORTD & 0xF0)| instr >> 4;
    LATD6 = 1; _delay((unsigned long)((1)*(64000000/4000000.0))); LATD6 = 0;
    _delay((unsigned long)((1)*(64000000/4000000.0)));
    PORTD = (PORTD & 0xF0)|(instr & 0x0F);
    LATD6 = 1; _delay((unsigned long)((1)*(64000000/4000000.0))); LATD6 = 0;
    _delay((unsigned long)((1)*(64000000/4000000.0)));
...
unsigned char LCDprint(char *c){
    ...
    do{
        ...
        PORTD = (PORTD & 0xF0)|(c[i]>>4);
        LATD6 = 1; _delay((unsigned long)((1)*(64000000/4000000.0))); LATD6 = 0;
        PORTD = (PORTD & 0xF0)|(c[i] & 0x0F);
        LATD6 = 1; _delay((unsigned long)((1)*(64000000/4000000.0))); LATD6 = 0;
        address = busy();
...
unsigned char LCDgoto(unsigned char pos){
    LCDinstruct(0x80+pos);
    unsigned char address = busy();
    return address;
}
...
void LCDreturn(){
    ...
    unsigned char add = LCDprint("");
    unsigned char next_line = 0x3F;
