...
main: ; program starts here
    ...
    clrf WREG ;clear the working reg
    clrf COUNTER, A ;set the counter reg
    clrf PORTC
...
waitForRelease:
    btfsc ((PORTB) and 0FFh), 4, a ;register b bit 4 ;is button released?
